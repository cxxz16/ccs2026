...
VARIANT_CODE_DIR = "./sig_gene_results/variant_results/variant_code"
VARIANT_STRATEGY_DIR = "./sig_gene_results/variant_results/variant_strategy"
...
def vuln_check(cve_id, source_code_filepath, model="gpt-5"):
    ...
    is_vulnerable = True  # 先全部当作有漏洞的，后续再完善漏洞判断逻辑
